...
with open("Orthogroups_1.GeneCount.csv",'rt') as file:
...
"""cover main group"""
mainspecies=['Md_he','Cb_he','SRA_Cd_he', 'Zn_he','Hs_454_he','Nc_he','Kf_he','Rf_he','Cf_he','Rs_454_he','Pi_he','SRA_Ps_he']
mainindexdict={e:i for i,e in enumerate(num[0]) if e in mainspecies}
maingroup=[entry for entry in num[1:] if entry[mainindexdict['Md_he']]==1 and (entry[mainindexdict['Cb_he']]==1 or entry[mainindexdict['SRA_Cd_he']]==1) and (entry[mainindexdict['Hs_454_he']]==1 or entry[mainindexdict['Zn_he']]==1) and (entry[mainindexdict['Nc_he']]==1 or entry[mainindexdict['Kf_he']]==1) and entry[mainindexdict['Cf_he']]==1 and (entry[mainindexdict['Rf_he']]==1 or entry[mainindexdict['Rs_454_he']]==1) and (entry[mainindexdict['Pi_he']]==1 or entry[mainindexdict['SRA_Ps_he']]==1)]
...
with open("Orthogroups_1.csv",'rt') as file:
